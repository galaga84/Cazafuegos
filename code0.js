...
gdjs.MainMenuCode.GDScreenOrientationCheckerObjects3= [];
...
gdjs.MainMenuCode.GDNewSprite4Objects3= [];
...
gdjs.copyArray(runtimeScene.getObjects("MusicSlider"), gdjs.MainMenuCode.GDMusicSliderObjects2);
gdjs.copyArray(runtimeScene.getObjects("SoundSlider"), gdjs.MainMenuCode.GDSoundSliderObjects2);
...
}{for(var i = 0, len = gdjs.MainMenuCode.GDSoundSliderObjects2.length ;i < len;++i) {
    gdjs.MainMenuCode.GDSoundSliderObjects2[i].SetValue(runtimeScene.getGame().getVariables().getFromIndex(0).getChild("Sound").getAsNumber(), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}{for(var i = 0, len = gdjs.MainMenuCode.GDMusicSliderObjects2.length ;i < len;++i) {
    gdjs.MainMenuCode.GDMusicSliderObjects2[i].SetValue(runtimeScene.getGame().getVariables().getFromIndex(0).getChild("Music").getAsNumber(), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}}
...
if (isConditionTrue_0) {
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "Introducción", false);
}}
...
gdjs.MainMenuCode.GDScreenOrientationCheckerObjects3.length = 0;
...
gdjs.MainMenuCode.GDNewSprite4Objects3.length = 0;
